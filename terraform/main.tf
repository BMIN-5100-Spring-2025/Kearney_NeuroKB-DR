...
resource "aws_s3_bucket_cors_configuration" "kearneyneurokb-dr_cors_configuration" {
  ...
  cors_rule {
    ...
    allowed_origins = ["http://localhost:3000", "bmin5100.com", "*.bmin5100", "http://localhost:5173"]
    expose_headers  = ["ETag"]
...
module "invoke_fargate_lambda" {
  ...
  project_name = "kearney_neurokb_dr"
  ecs_task_definition_arn = aws_ecs_task_definition.kearney_neurokb_dr.arn
  ecs_task_execution_role_arn = aws_iam_role.ecs_task_execution_role.arn
  ecs_task_task_role_arn = aws_iam_role.ecs_task_role.arn
  ecs_task_definition_container_name = "kearney_neurokb_dr"
